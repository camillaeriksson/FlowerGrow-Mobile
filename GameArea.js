...
export default class GameArea extends Component {
  ...
  setupWorld = () => {
    ...
    let waterMeterBackground = Matter.Bodies.rectangle(35, max_height - 150, 30, 160, { isStatic: true });
    let stem = Matter.Bodies.rectangle(max_width / 2, max_height + 500, 100, 800);
    let waterMeter = Matter.Bodies.rectangle(35, max_height - 150, 30, 160, { isStatic: true });
    ...
    return {
      ...
      waterMeter: { body: waterMeter, color: '#1F63E0', size: [30, 160], waterLevel: 160, newWaterMeterY: max_height - 150, renderer: WaterMeter}
    }
  }
